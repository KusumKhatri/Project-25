...
function setup() {
	...
	leftSide = new Ground(1100,590,10,180);
	rightSide = new Ground(1270,590,10,180);
	bottomSide = new Ground(1185,670,150,20);
...
function draw() {
	...
	image(dustbinImg, 1185, 590, 200,200);
...
function keyPressed() {
  	if (keyCode === UP_ARROW) {
		...
		Matter.Body.applyForce(ball,ball.position,{x:66,y:-60});
